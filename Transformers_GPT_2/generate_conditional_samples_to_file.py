...
def main():
    ...
    parser.add_argument("--model_descr", type=str, default="ABC")
    ...
    while True:
        ...
        write_path = "outputs/"
        s=str(args.model_name_or_path).split("/")
    
        model_descr = args.model_descr + "_" + s[1]

        gen_file = '{:%Y_%m_%d_%H_%M_%S}_{}'.format(datetime.utcnow(), model_descr)
        ...
        details_string = (model_descr + "," + " seed:" + str(args.seed) + "," + " samples:" + 
