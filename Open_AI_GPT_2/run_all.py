...
for i in range(1,11):
    ...
    for s in range(seed_start, seed_end):
        ...
        os.system('python generate_conditional_samples_to_file.py --raw_text {prompt} --model_descr {} --model_name model_{} --length {} --seed {} --temperature 1.0 --top_k 50 --top_p 1.0'.format(prompt, model_descr, ckpt, sample_length, s))
