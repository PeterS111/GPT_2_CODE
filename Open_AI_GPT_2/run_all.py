...
directory_path = "/content/Open_AI_GPT_2_fine_tune_and_generate/"
...
for i in range(1,11):
    ...
    # os.system('python train.py --dataset {} --val_dataset {} --val_every 50 --model_name {} --top_k 50 --top_p 1.0 --max_steps {} --save_every {} --max_to_keep 10  --val_batch_count 40'.format(input_train, input_val, model_size, ckpt, ckpt))
    ...
    for s in range(seed_start, seed_end):
        ...
        os.system('python generate_conditional_samples_to_file.py --raw_text {prompt} --model_descr {} --model_name model_{} --length {} --seed {} --temperature 1.0 --top_k 50 --top_p 1.0 --nsamples 1'.format(prompt, model_descr, ckpt, sample_length, s))
